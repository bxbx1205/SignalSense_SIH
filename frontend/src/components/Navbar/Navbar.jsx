...
const Navbar = ({ currentMode, onModeChange }) => {
      ...
      <div className="navbar-content">
        ...
        <div className="navbar-left">
          <div className="logo-container">
            ...
            <div className="logo-text">
              <span className="brand-name">Railways</span>
              <span className="brand-subtitle">AI powered railway management</span>
            </div>
          </div>
        </div>
        ...
        <div className="navbar-right">
          <div className="mode-buttons-container">
            <button 
              className={`mode-button ${currentMode === 'Operator' ? 'active' : ''}`} 
            ...
            <button 
              className={`mode-button ${currentMode === 'Viewer' ? 'active' : ''}`} 
